...
## Read first
- `context/who-i-am.md` — your working days, platforms, languages, and audience. If **Where you post**
  reads `none`, say so plainly and ask whether they want to start publishing before planning a week of it.
- Your `context/voice.md` — tone for the script bodies.

## Pillar rhythm (default — adjust to `context/who-i-am.md`)
