...
name: knowing
description: >
  知 (Knowing) — the Clarity loop. Use to think clearly before you build: see
  your whole OS at a glance, and understand why people buy. Trigger on "system
  map", "see the whole system", "show me the OS at a glance", "marketing
  psychology", "mental models", "why people buy", "which psychology applies
  here", "anchoring", "social proof", "scarcity", "loss aversion", "framing",
  "what should I focus on this week", "help me get clear".
